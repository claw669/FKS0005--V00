...
| 8 | M3*6+5mm 黑色单通尼龙柱| 4 |![Img](./media/dantong.png) |
| 9 | M3*6mm 圆头螺钉| 8 | ![Img](./media/luosi.png)|
...
### 2.6.2 Micro:bit V2主板硬件介绍

![Img](./media/A549.png)

### 2.6.3 Micro:bit V2引脚配置介绍
...
### 2.6.4 Micro:bit V2主板注意事项

2. Micro:bit主板上有很多精密的电子元件，建议戴上硅胶保护套进行使用，防止短路。
